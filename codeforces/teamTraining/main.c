...
// basicamente eu comentei v;
// tb comentei a leitura direto no vetor, e fiz passar por uma variável primeiro...
// daí só guarda se for diferente de 1 e 0;